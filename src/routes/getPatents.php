...
$app->post('/api/NasaAPI/getPatents', function ($request, $response, $args) {
    ...
    $query_str = 'https://api.nasa.gov/patents/content';
    ...
    if(!empty($post_data['args']['conceptTags'])) {
        $body['concept_tags'] = $post_data['args']['conceptTags'];
    }
